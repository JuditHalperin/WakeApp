...
class Infopage:
    def __init__(self, root):
        ...
        title = Label(info_page, text="Enter details here", font=("Arial", 25, "bold"), fg="sky blue",
                      bg="white").place(x=60, y=20)
        desc = Label(info_page, text="Driver Drowsiness Detection System", font=("Goudy pld style", 13, "bold"),
                     fg="sky blue",
                     bg="white").place(x=55, y=70)
        # ======labels and txt box=====
        lbl_driver_name = Label(info_page, text="Name driver", font=("Goudy pld style", 15, "bold"),
                                fg="gray",
                                bg="white").place(x=30, y=115)
        ...
        lbl_name_contact = Label(info_page, text="Name contact", font=("Goudy pld style", 15, "bold"),
                                 fg="gray",
                                 bg="white").place(x=30, y=180)
        ...
        lbl_email_contact = Label(info_page, text="Email contact", font=("Goudy pld style", 15, "bold"),
                                  fg="gray",
                                  bg="white").place(x=30, y=240)
        ...
        start_button = Button(self.root, command=self.start_function, text="Start", bg="sky blue",
                              font=("times new roman", 12)).place(x=150, y=500,
                                                                  width=100, height=30)
