...
class InfoPage:
    ...
    def __init__(self, root):
        ...
        Label(info_page, text="Contact name", font=("Goudy pld style", 12, "bold"), fg="#B80008", bg="white").place(x=30, y=200)
        ...
        Label(info_page, text="Contact email", font=("Goudy pld style", 12, "bold"), fg="#B80008", bg="white").place(x=30, y=260)
        ...
        # start button
        Button(self.root, command=self.start_function, text="Start Driving", bg="#ABCAD5", font=("times new roman", 12)).place(x=150, y=346, width=100, height=30)
